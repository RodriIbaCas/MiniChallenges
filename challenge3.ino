...
std_msgs__msg__Float32 msg_pot;
...
#define LED_PIN 5  //--> Equipo 13
#define POT_PIN 13  //--> Equipo 36
//#define PWM_PIN 15
#define LED2_PIN 18 //--> Equipo 15
...
void subscription_callback(const void *msgin){
  const std_msgs__msg__Float32 * msg = static_cast<const std_msgs__msg__Float32 *>(msgin);
